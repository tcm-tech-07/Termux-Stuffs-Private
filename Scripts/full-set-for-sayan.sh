...
apt install -y mesa-zink mesa-zink-dev virglrenderer-mesa-zink vulkan-loader-generic angle-android virglrenderer-android libandroid-shmem libc++ libdrm libx11 libxcb libxshmfence libwayland zlib zstd
...
wget -O Backup-Sayan.tar.xz \
https://github.com/tcm-tech-07/Termux-Stuffs-Private/releases/download/v1.0/Backup-Sayan.tar.xz

tar -xvJf Backup-Sayan.tar.xz

rsync -avh ~/TCM-Bhai-Config/Sayan/ ~/
